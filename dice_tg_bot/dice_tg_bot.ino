...
int get_random_num(int minVal, int maxVal) {
  ...
  if (db[kk::random_mode] == 2) {
    client.setInsecure();
    String url = "/integers/?num=1&min=" + String(minVal) + "&max=" + String(maxVal) + "&col=1&base=10&format=plain&rnd=new"; //https://www.random.org/integers/?num=1&min=1&max=20&col=1&base=10&format=plain&rnd=new
